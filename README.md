...
```bash
cf set-env risk-analysis-api AUTH_URL "..."
cf set-env risk-analysis-api CLIENT_ID "..."
cf set-env risk-analysis-api CLIENT_SECRET "..."
cf set-env risk-analysis-api DEPLOYMENT_ID "..."
cf restage risk-analysis-api
```
...
```bash
cf app risk-analysis-api              # status, memory, instances
cf logs risk-analysis-api --recent    # last logs
cf logs risk-analysis-api             # live log stream
```

### Scaling

```bash
cf scale risk-analysis-api -i 2    # 2 instances
cf scale risk-analysis-api -m 1G   # increase memory
```
